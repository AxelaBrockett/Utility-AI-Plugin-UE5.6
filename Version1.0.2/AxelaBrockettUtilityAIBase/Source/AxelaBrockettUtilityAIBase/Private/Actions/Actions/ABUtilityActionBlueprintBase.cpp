...
#if WITH_GAMEPLAY_DEBUGGER_MENU
void UABUtilityActionBlueprintBase::DescribeSelfToGameplayDebugger(const UABUtilityComponent& OwnerComp, const bool bUseConsiderationFactor, FGameplayDebuggerCategory* DebuggerCategory) const
{
