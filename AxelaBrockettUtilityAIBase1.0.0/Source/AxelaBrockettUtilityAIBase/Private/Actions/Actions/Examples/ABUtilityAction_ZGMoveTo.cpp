...
#if WITH_GAMEPLAY_DEBUGGER_MENU
void UABUtilityAction_ZGMoveTo::DescribeSelfToGameplayDebugger(const UABUtilityComponent& OwnerComp, FGameplayDebuggerCategory* DebuggerCategory) const
{
	...
	if (IsValid(AIController))
	{
		...
		RestartActionOnMoveCompleted.BindData(AIController, INDEX_NONE);
		AcceptableRadius.BindData(AIController, INDEX_NONE);
		MovementGoalAdvancementDistance.BindData(AIController, INDEX_NONE);
	}
