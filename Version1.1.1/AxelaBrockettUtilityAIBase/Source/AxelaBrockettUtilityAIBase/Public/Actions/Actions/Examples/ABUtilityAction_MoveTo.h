...
UCLASS()
class UABUtilityActionMoveToInstanceMemory : public UABUtilityActionInstanceMemoryBase
{
	GENERATED_BODY()
...
public:
	...
	friend UABUtilityAction_MoveTo;
...
public:
	...
	{
		return UABUtilityActionMoveToInstanceMemory::StaticClass();
	}
...
private:
	// Internal move logic
	void PrepareMoveRequest(AAIController& AIController, UABUtilityActionMoveToInstanceMemory& MoveToMemory);
	EABUtilityActionRunStatus StartEQS(
		const UEnvQuery& EQSToRun,
		AAIController& AIController,
		UABUtilityActionMoveToInstanceMemory& MoveToMemory
	);
	EABUtilityActionRunStatus StartMoveTowardsActorOfClass(AAIController& AIController, UABUtilityActionMoveToInstanceMemory& MoveToMemory);
	const bool HandleMoveTask(AAIController& AIController, UABUtilityActionMoveToInstanceMemory& MoveToMemory);
	const bool ShouldUpdateMove(AAIController& AIController, const UABUtilityActionMoveToInstanceMemory& MoveToMemory);

	// Delegate callbacks
	void OnEQSFinished(TSharedPtr<FEnvQueryResult> Result, UABUtilityActionMoveToInstanceMemory* MoveToMemory);
	void OnMoveFinished(
