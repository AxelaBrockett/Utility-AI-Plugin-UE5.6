...
UCLASS()
class UABUtilityActionZGMoveToInstanceMemory : public UABUtilityActionInstanceMemoryBase
{
	GENERATED_BODY()
...
public:
	void Reset() override
	{
		CachedRequestID = FAIRequestID::InvalidRequest;
		CurrentLane.Reset();
		bNewMovementRequired = false;
#if WITH_GAMEPLAY_DEBUGGER_MENU
		DebugStartLocation = FAISystem::InvalidLocation;
#endif 
	}

	friend UABUtilityAction_ZGMoveTo;
...
public:
	...
	{
		return UABUtilityActionZGMoveToInstanceMemory::StaticClass();
	}
...
private:
	// Internal move logic
	EABUtilityActionRunStatus GenerateZGMoveToLocation(
		UABUtilityComponent& OwnerComp,
		AAIController& AIController,
		UABUtilityActionZGMoveToInstanceMemory& ZGMemory
	);
	EABUtilityActionRunStatus StartZGMoveTo(
		AAIController& AIController,
		UABUtilityActionZGMoveToInstanceMemory& ZGMemory
	);
	const bool HandleAdvancingLaneLocation(
